...
public class test  {
	 ...
	 */
	public <V extends Vertex> ArrayList<Set<V>> partitionGraph(WeightedGraph<V, DefaultWeightedEdge> graph, int numPartitions){
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i< num; i++){
			NodeVertex vertex = new NodeVertex(i+"");
...
//			for (int j=0;j<num;j++){
				...
				terminationVertex = nodeToVertex.get(1+"");  
				 originVertex = nodeToVertex.get(3+"");  
				...
				terminationVertex = nodeToVertex.get(2+"");  
				 originVertex = nodeToVertex.get(4+"");  
				...
				test test1= new test();
				ArrayList<Set<NodeVertex>> result= test1.partitionGraph(networkGraph,3);
